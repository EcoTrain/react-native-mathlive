...
export function convertDimensionToPt(value?: Dimension, precision?: number): number {
  if (!value) return 0;
...
export function convertDimensionToEm(value?: Dimension | null, precision?: number): number {
